<template>
	<svg class="belong-underline-svg svg-writeon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 191 61" style="opacity: 0;enable-background:new 0 0 191 61;" xml:space="preserve" aria-hidden="true" focusable="false" role="img">
	 <mask id="belong-underline-mask">
	<path id="mask" style="fill:white;" d="M146.4,19.9c-1.9,0-13-0.2-24.5-0.4c-26.3-0.4-58.8,1.3-86.3,4.4
	...
	<path ref="writeon" mask="url(#belong-underline-mask)" :style="svgStyle" fill="none" stroke="#DBE0FA" stroke-width="7" stroke-miterlimit="10" d="M5.5,36.1
